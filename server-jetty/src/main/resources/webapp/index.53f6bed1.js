var e=globalThis,t={},s={},a=e.parcelRequire0031;null==a&&((a=function(e){if(e in t)return t[e].exports;if(e in s){var a=s[e];delete s[e];var i={id:e,exports:{}};return t[e]=i,a.call(i.exports,i,i.exports),i.exports}var l=Error("Cannot find module '"+e+"'");throw l.code="MODULE_NOT_FOUND",l}).register=function(e,t){s[e]=t},e.parcelRequire0031=a),a.register;var i=a("hNeh9"),l=a("800sp");class d extends l.LitElement{static styles=[i.default,(0,l.css)`
  json-viewer {
    --font-size: .8rem;
  }`];static properties={};threadMap=new Map;#e;get selectedTab(){return this.#e}set selectedTab(e){this.#e=e,this.dispatchEvent(new CustomEvent("update-thread",{detail:e,bubbles:!0,composed:!0,cancelable:!0}))}constructor(){super()}connectedCallback(){super.connectedCallback(),this.addEventListener("result",this.#t),this.addEventListener("init-threads",this.#s)}disconnectedCallback(){super.disconnectedCallback(),this.removeEventListener("result",this.#t),this.removeEventListener("init-threads",this.#s)}#s=e=>{let{detail:t=[]}=e;console.debug(t),this.threadMap=new Map(t),t&&t.length>0&&(this.selectedTab=t[0][0],this.requestUpdate())};#t=e=>{let[t,s]=e.detail;if(console.debug("onResult",t,s),!this.threadMap.has(t))throw Error("result doesn't contain a valid thread!");console.debug("onResult",t);let a=this.threadMap.get(t),i=a.push(s);this.threadMap.set(t,a),this.dispatchEvent(new CustomEvent("graph-active",{detail:s.node,bubbles:!0,composed:!0,cancelable:!0})),this.requestUpdate(),this.updateComplete.then(()=>{let e=`#json${i-1}`,t=this.shadowRoot.querySelectorAll(e);for(let s of(console.debug(e,t),t))s.expandAll()})};#a(e){console.debug(e.target.id),this.selectedTab=e.target.id,this.requestUpdate()}#i(e){console.debug("NEW TAB",e);let t=`Thread-${this.threadMap.size+1}`;this.threadMap.set(t,[]),this.selectedTab=t,this.requestUpdate()}#l(e,t){return(0,l.html)`
    ...
    ${e.map(e=>(0,l.html)`<a id="${e}" @click="${this.#a}" role="tab" class="tab ${this.selectedTab===e?"tab-active":""}" >${e}</a>`)}
        ...
        <div role="tablist" class="tabs tabs-bordered">
            ...
            <div class="max-h-[95%] overflow-x-auto bg-slate-500">
              <table class="table table-pin-rows">
                <tbody>
                    ${this.threadMap.get(this.selectedTab)?.map((e,t)=>l.html`<tr><td>${this.#l(e,t)}</td></tr>`)}
                </tbody>
              </table>
            </div>
        </div> 
       
    `}#r(e,t){return(0,l.html)`
      <div class="collapse collapse-arrow bg-base-200">
        <input type="radio" name="item-1" checked="checked" />
        <div class="collapse-title text-ml font-bold">${e.node}</div>
        <div class="collapse-content">
