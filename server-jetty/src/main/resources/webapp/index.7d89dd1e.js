...
flowchart TD
  ...
  node2:::node2 --> stop:::stop
    ...
    `}async #a(){if(this.test){await this.#s();return}let t=Object.keys(this.formMetaData).reduce((t,e)=>(t[e]=this.shadowRoot.getElementById(e).value,t),{});for await(let e of o(await fetch(`${this.url}/stream`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(t)})))console.debug(e),this.dispatchEvent(new CustomEvent("result",{detail:JSON.parse(e),bubbles:!0,composed:!0,cancelable:!0}))}async #s(){let t=async t=>{await r(1e3),this.dispatchEvent(new CustomEvent("result",{detail:{node:t,state:{input:"this is input",property1:{value:"value1",valid:!0},property2:{value:"value2",children:{elements:[1,2,3]}}}},bubbles:!0,composed:!0,cancelable:!0}))};await t("start"),await t("node1"),await t("node2"),await t("stop")}}window.customElements.define("lg4j-executor",l);
