 ...
 * {@link org.bsc.langgraph4j.StateGraph}, {@link org.bsc.langgraph4j.CompiledGraph}, {@link org.bsc.langgraph4j.Node}, and {@link org.bsc.langgraph4j.Edge}, which
 ...
 *   <li>{@link org.bsc.langgraph4j.Node} - Represents a node in the graph with a unique identifier and an associated action.</li>
 *   <li>{@link org.bsc.langgraph4j.Edge} - Represents an edge in the graph with a source ID and a target value.</li>
 * </ul>
 *
 * <p>Utility classes:</p>
 * <ul>
