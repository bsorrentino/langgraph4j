					...
					return Data.composeWith(generator.map(n -> {
						...
						if (data != null) {
							...
							if (data instanceof Map<?, ?>) {
								...
								var intermediateState = AgentState.updateState(currentState,
										partialStateWithoutGenerator, stateGraph.getChannels());

								currentState = AgentState.updateState(intermediateState, (Map<String, Object>) data,
