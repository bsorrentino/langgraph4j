...
public record GraphRepresentation(Type type, String content) {
	 ...
	 * @deprecated Please use {@link #type()} instead. This method is no longer maintained
	 ...
	 * @deprecated Please use {@link #content()} instead. This method is no longer
	 * maintained and may be removed in future versions.
	 */
	@Deprecated
