...
public class Issue104Test {
	...
	public void testParallelBranchesWithCompiledSubGraph() throws GraphStateException {
		...
		var subgraphA3 = new MessagesStateGraph<String>().addNode("A3.1", makeNode("A3.1"))
	...
	public void testParallelBranchesWithMoreCompiledSubGraph() throws GraphStateException {
		...
		var subgraphA3 = new MessagesStateGraph<String>().addNode("A3.1", makeNode("A3.1"))
			...
			.addEdge("A3.2", END)
			.compile();
		var subgraphA1 = new MessagesStateGraph<String>().addNode("A1.1", makeNode("A1.1"))
	...
	public void testParallelBranchesWithAllCompiledSubGraph() throws GraphStateException {
		...
		var subgraphA3 = new MessagesStateGraph<String>().addNode("A3.1", makeNode("A3.1"))
			...
			.addEdge("A3.2", END)
			.compile();
		var subgraphA2 = new MessagesStateGraph<String>().addNode("A2.1", makeNode("A2.1"))
		...
		assertTrue(result.isPresent());
		assertIterableEquals(List.of("A", "A1.1", "A1.2", "A2.1", "A2.2", "A3.1", "A3.2", "B"),
				result.get().messages());
