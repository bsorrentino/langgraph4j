var e=globalThis,t={},a={},i=e.parcelRequire94c2;null==i&&((i=function(e){if(e in t)return t[e].exports;if(e in a){var i=a[e];delete a[e];var n={id:e,exports:{}};return t[e]=n,i.call(n.exports,n,n.exports),n.exports}var s=Error("Cannot find module '"+e+"'");throw s.code="MODULE_NOT_FOUND",s}).register=function(e,t){a[e]=t},e.parcelRequire94c2=i),i.register;var n=i("hNeh9"),s=i("800sp");const l=async e=>new Promise(t=>setTimeout(t,e)),_={callInit:async e=>{let t={threads:[["default",[]]],title:"LangGraph4j : TEST",args:[{name:"input",type:"IMAGE",required:!0}],graph:`
---
...
subgraph evaluate_result
  ...
  `];static properties={url:{type:String,reflect:!0},test:{type:Boolean,reflect:!0},_executing:{state:!0}};url=null;#e;#t=null;interrupted=!1;constructor(){super(),this.test=!1,this.formMetaData=[],this._executing=!1}#a(e){console.debug("thread-updated",e.detail),this.#e=e.detail,this.#t=null,this.requestUpdate()}#i(e){console.debug("onNodeUpdated",e),this.#t=e.detail,this.requestUpdate()}connectedCallback(){if(super.connectedCallback(),this.addEventListener("thread-updated",this.#a),this.addEventListener("node-updated",this.#i),this.test){_.callInit(this).then(e=>{this.formMetaData=e.args,this.requestUpdate()});return}this.#n()}disconnectedCallback(){super.disconnectedCallback(),this.removeEventListener("thread-updated",this.#a),this.removeEventListener("node-updated",this.#i)}render(){return(0,s.html)`
        <div class="container">
          ...
          <div class="commands">
            <button id="submit" ?disabled=${this._executing} @click="${this.#s}" class="btn btn-primary item1">Submit</button>
            <button id="resume" ?disabled=${!this.#t||this._executing} @click="${this.#l}" class="btn btn-secondary item2">
            Resume ${this.#t?"(from "+this.#t?.node+")":""}
            </button>
          </div>
        </div>
        `}async #n(){let e=await fetch(`${this.url}/init`),t=await e.json();console.debug("initData",t),this.dispatchEvent(new CustomEvent("init",{detail:t,bubbles:!0,composed:!0,cancelable:!0})),this.formMetaData=t.args,this.requestUpdate()}async #l(){this._executing=!0;try{if(this.test){await _.callSubmitAction(this,this.#e);return}await this.#_()}finally{this._executing=!1}}async #_(){let e=await fetch(`${this.url}/stream?thread=${this.#e}&resume=true&interrupted=${this.interrupted}&node=${this.#t?.node}&checkpoint=${this.#t?.checkpoint}`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(this.#t?.data)});for await(let t of(this.#t=null,r(e)))console.debug(t),this.dispatchEvent(new CustomEvent("result",{detail:JSON.parse(t),bubbles:!0,composed:!0,cancelable:!0}))}async #s(){this._executing=!0;try{if(this.test){await _.callSubmitAction(this,this.#e);return}await this.#r()}finally{this._executing=!1}}async #r(){let e=this.formMetaData.reduce((e,t)=>{let{name:a,type:i}=t,n=this.shadowRoot?.getElementById(a);switch(i){case"STRING":case"IMAGE":e[a]=n?.value}return e},{}),t=await fetch(`${this.url}/stream?thread=${this.#e}`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(e)}),a=null;for await(let e of r(t))console.debug(e),a=JSON.parse(e),this.dispatchEvent(new CustomEvent("result",{detail:a,bubbles:!0,composed:!0,cancelable:!0}));this.interrupted=!!a&&"__END__"!==a[1].node,console.debug("LAST CHUNK",a,this.interrupted)}}window.customElements.define("lg4j-executor",c);
//# sourceMappingURL=index.9e23df65.js.map
