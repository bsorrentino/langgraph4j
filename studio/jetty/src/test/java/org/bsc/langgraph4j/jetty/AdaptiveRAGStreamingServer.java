...
public class AdaptiveRAGStreamingServer {
	...
	public static void main(String[] args) throws Exception {
		...
		// [Serializing with Jackson (JSON) - getting "No serializer
		// found"?](https://stackoverflow.com/a/8395924/521197)
		// ObjectMapper objectMapper = new ObjectMapper();
		// objectMapper.setVisibility(PropertyAccessor.FIELD,
		// JsonAutoDetect.Visibility.ANY);

		System.out.println(app.getGraph(GraphRepresentation.Type.MERMAID, "ADAPTIVE RAG EXECUTOR", false).content());
