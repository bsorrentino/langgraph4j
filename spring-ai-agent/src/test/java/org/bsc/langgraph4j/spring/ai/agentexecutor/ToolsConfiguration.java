...
/**
 * Configuration class for various functions related to weather. This configuration class
 * provides methods to define and execute weather-related functions.
 */
@Configuration
public class ToolsConfiguration {
	 ...
	 * @return A FunctionCallback object that wraps a WeatherFunction and provides
	 * metadata about it.
	 */
	@Bean
