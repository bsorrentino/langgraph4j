...
/**
 * Class representing the WeatherFunction which implements a Function interface to
...
public class WeatherFunction implements Function<WeatherFunction.Request, WeatherFunction.Response> {
	...
	/**
	 * Record representing the request object for WeatherFunction. Only contains the city
	...
	/**
	 * Record representing the response object returned by the WeatherFunction. Contains
	 * location and current weather details.
	 */
	public record Response(Location location, Current current) {
	}

	/**
	 * Record representing location information as part of the weather response. Includes
	 * name, region, country, latitude, and longitude.
	 */
	 ...
	 * Includes temperature in Fahrenheit, condition description, wind speed in miles per
	 * hour, and humidity.
	 */
	 ...
	 * @param weatherRequest The request object containing the city for which weather data
	 * is required.
