...
/**
 * The ChromaStore class provides a singleton interface for interacting with the Chroma
 * Embedding Store. This class is designed to be used in conjunction with an OpenAI API
 * key to perform search operations on text segments. It abstracts the embedding model and
 * the storage layer, offering a simple method to retrieve relevant data based on queries.
 */
public final class ChromaStore {
	...
	private final ChromaEmbeddingStore chroma = new ChromaEmbeddingStore("http://localhost:8000", "rag-chroma",
			Duration.ofMinutes(2), true, true);

	private final OpenAiEmbeddingModel embeddingModel;

	/**
	 * This constructor initializes a new instance of the ChromaStore with the provided
	 * OpenAI API key.
	 ...
	 * @return An EmbeddingSearchResult containing up to one TextSegment that best matches
	 * the query.
	 */
