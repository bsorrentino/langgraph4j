...
/**
 * The `ImageLoader` class provides utility methods for loading and converting images to
 * Base64 format.
 */
public class ImageLoader {
	...
	/**
	 * Loads an image from an input stream and returns its Base64 encoded string
	 * representation.
