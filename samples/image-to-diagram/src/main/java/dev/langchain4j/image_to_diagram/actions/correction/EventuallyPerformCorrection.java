...
/**
 * This is an example of a public class designed to eventually perform correction. It
 * implements the AsyncNodeActionWithConfig interface specifically tailored for
...
public class EventuallyPerformCorrection implements AsyncNodeActionWithConfig<ImageToDiagram.State> {
	 ...
	 * @return a CompletableFuture that will contain a Map object with the resulting
	 * diagram or an exception if the conversion fails
