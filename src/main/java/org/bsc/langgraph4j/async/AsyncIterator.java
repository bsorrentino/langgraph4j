    ...
    default Iterator<T> iterator() {
        return new Iterator<T>() {
            ...
            public boolean hasNext() {
                ...
                return !currentFetchedData.updateAndGet( (v) -> AsyncIterator.this.next().join() ).isDone();
            }
            ...
            public T next() {
                ...
                if (currentFetchedData.get().isDone()) {
                    throw new NoSuchElementException("no more elements into iterator");
                }
                return currentFetchedData.getAndUpdate((v) -> null).getData();
            }
        };
    }
