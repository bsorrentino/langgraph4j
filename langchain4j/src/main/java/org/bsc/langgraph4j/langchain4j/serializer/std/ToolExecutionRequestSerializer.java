...
/**
 * The ToolExecutionRequestSerializer class implements the Serializer interface for the
 * ToolExecutionRequest type. It provides methods to serialize and deserialize
