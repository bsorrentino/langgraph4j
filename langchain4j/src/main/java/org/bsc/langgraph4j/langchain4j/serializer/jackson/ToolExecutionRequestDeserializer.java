...
public class ToolExecutionRequestDeserializer extends StdDeserializer<ToolExecutionRequest> {
	 ...
	 * @param ctx the DeserializationContext that can be used to access additional
	 ...
	 */
	@Override
	public ToolExecutionRequest deserialize(JsonParser parser, DeserializationContext ctx)
