...
/**
 * This class is responsible for serializing and deserializing instances of
 * ToolExecutionResultMessage. It implements the Serializer interface to provide custom
 * serialization logic.
 */
public class ToolExecutionResultMessageSerializer implements NullableObjectSerializer<ToolExecutionResultMessage> {
	...
	private static final org.slf4j.Logger log = org.slf4j.LoggerFactory
		.getLogger(ToolExecutionResultMessageSerializer.class);

	/**
	 * Serializes the given ToolExecutionResultMessage object to the provided ObjectOutput
	 * stream.
	...
	/**
	 * Deserializes a ToolExecutionResultMessage object from the provided ObjectInput
	 * stream.
