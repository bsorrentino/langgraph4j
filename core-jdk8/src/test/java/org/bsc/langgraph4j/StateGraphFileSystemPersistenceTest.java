...
public class StateGraphFileSystemPersistenceTest
{
    ...
    public void testCheckpointInitialState() throws Exception {
        ...
        FileSystemSaver saver = new FileSystemSaver(Paths.get( rootPath, "testCheckpointInitialState" ), workflow.getStateSerializer() );
    ...
    public void testCheckpointSaverResubmit() throws Exception {
        ...
        FileSystemSaver saver = new FileSystemSaver(Paths.get( rootPath, "testCheckpointSaverResubmit" ), workflow.getStateSerializer() );
    ...
    public void testViewAndUpdatePastGraphState() throws Exception {
        ...
        FileSystemSaver saver = new FileSystemSaver(Paths.get( rootPath, "testViewAndUpdatePastGraphState" ), workflow.getStateSerializer() );
    ...
    public void testPauseAndUpdatePastGraphState() throws Exception {
        ...
        FileSystemSaver saver = new FileSystemSaver(Paths.get( rootPath, "testPauseAndUpdatePastGraphState" ), workflow.getStateSerializer() );
