...
/**
 * Abstract class for diagram generation. This class provides a framework for generating textual
...
public abstract class DiagramGenerator {
  ...
  /**
   * This method is an abstract method that must be implemented by subclasses. It is used to
   * initiate a communication call between two parties identified by their phone numbers.
   *
  ...
  protected abstract void call(
      Context ctx, String from, String to, String description, CallStyle style);

  /**
   * Declares a conditional element in the configuration or template. This method is used to mark
   * the start of a conditional section based on the provided {@code name}. It takes a {@code
   * Context} object that may contain additional parameters necessary for the declaration, and a
   * {@code name} which identifies the type or key associated with the conditional section.
   *
   ...
   * @param yesOrNo Whether the line should be uncommented ({@literal true}) or commented ({@literal
   *     false}).
   */
   ...
   */
  public final <State extends AgentState> String generate(
   ...
   */
  protected final <State extends AgentState> Context generate(
      StateGraph.Nodes<State> nodes, StateGraph.Edges<State> edges, Context ctx) {
  ...
  private <State extends AgentState> void handleCommandNode(
      Context ctx, CommandNode<State> commandNode) {
    {
   ...
   */
  private <State extends AgentState> void edgeCondition(
      Context ctx, EdgeCondition<State> condition, String k, String conditionName) {
    commentLine(ctx, !ctx.printConditionalEdge());
  ...
  public record Context(
      StringBuilder sb, String title, boolean printConditionalEdge, boolean isSubGraph) {
